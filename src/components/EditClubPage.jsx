...
const EditClubPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [userResponse, clubResponse] = await Promise.all([
          ...
          axios.get(`https://club-manager-3k6y.vercel.app/api/clubs?name=${clubName}`, config),
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://club-manager-3k6y.vercel.app/api/clubs/${club._id}`, formData, {
        headers: {
