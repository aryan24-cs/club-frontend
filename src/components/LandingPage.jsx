    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-[Poppins]">
      ...
      >
        ...
        <div className="container mx-auto px-2 sm:px-4 flex flex-col items-center text-center relative z-10">
          ...
          >
            <FaUsers className="text-6xl sm:text-8xl text-teal-600" style={{ color: '#456882' }} />
          </motion.div>
          {/* Animated Heading */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/join" className="hover:text-teal-200 transition-colors">Join a Club</a></li>
